...
const TableEntry esrTables[NUM_PGA_SETTINGS][TABLE_ENTRIES] PROGMEM = {
    // PGA = 2× tabel (indeks 0) - 30 indgange
    {
        ...
        {500, 0.052}, {600, 0.090}, {700, 0.093}, {800,0.135}, {900, 0.162},
        {1000, 0.164}, {1100, 0.252}, {1200, 0.321}, {1300, 0.376}, {1400, 0.489},
        {1500, 0.759}, {1600, 0.847}, {1700, 1.000}, {1800, 1.500}, {1900, 1.960},
        {2000, 2.670}, {2100, 3.240}, {2200, 3.260}, {2300, 3.880}, {2400, 4.710},
        {2500, 5.560}, {2600, 7.360}, {2700, 9.980}, {2800, 9.995}, {2900, 9.999}
    },
    // PGA = 4× tabel (indeks 1) - 30 indgange  
    {
        {0, 0.000}, {200, 0.004}, {400, 0.010}, {600, 0.020}, {800, 0.033},
        {1000, 0.052}, {1200, 0.090}, {1400, 0.093}, {1600, 0.135}, {1800, 0.162},
        {2000, 0.164}, {2200, 0.252}, {2400, 0.321}, {2600, 0.376}, {2800, 0.489},
        {3000, 0.759}, {3200, 0.847}, {3400, 1.000}, {3600, 1.500}, {3800, 1.960},
        {4000, 2.670}, {4200, 3.240}, {4400, 3.260}, {4600, 3.880}, {4800, 4.710},
        {5000, 5.560}, {5200, 7.360}, {5400, 9.980}, {5600, 9.995}, {5800, 9.999}
    },
    // PGA = 8× tabel (indeks 2) - 30 indgange
    {
        {0, 0.000}, {400, 0.004}, {800, 0.010}, {1200, 0.020}, {1600, 0.033},
        {2000, 0.052}, {2400, 0.090}, {2800, 0.093}, {3200, 0.135}, {3600, 0.162},
        {4000, 0.164}, {4400, 0.252}, {4800, 0.321}, {5200, 0.376}, {5600, 0.489},
        {6000, 0.759}, {6400, 0.847}, {6800, 1.000}, {7200, 1.500}, {7600, 1.960},
        {8000, 2.670}, {8400, 3.240}, {8800, 3.260}, {9200, 3.880}, {9600, 4.710},
        {10000, 5.560}, {10400, 7.360}, {10800, 9.980}, {11200, 9.995}, {11600, 9.999}
    },
    // PGA = 16× tabel (indeks 3) - 30 indgange
    {
        {0, 0.000}, {800, 0.004}, {1600, 0.010}, {2400, 0.020}, {3200, 0.033},
        {4000, 0.052}, {4800, 0.090}, {5600, 0.093}, {6400, 0.135}, {7200, 0.162},
        {8000, 0.164}, {8800, 0.252}, {9600, 0.321}, {10400, 0.376}, {11200, 0.489},
        {12000, 0.759}, {12800, 0.847}, {13600, 1.000}, {14400, 1.500}, {15200, 1.960},
        {16000, 2.670}, {16800, 3.240}, {17600, 3.260}, {18400, 3.880}, {19200, 4.710},
        {20000, 5.560}, {20800, 7.360}, {21600, 9.980}, {22400, 9.995}, {23200, 9.999}
    }
};
